...
plot(x_sample_fit/1e3,ysamp_val,'b')


scatter((f-theory_cen)/1e3,pmt_volt,'*')
...
hold on
box on
errorbar(data_b(:,1)/1e3,data_b(:,3)-0.5989,4*log(4).*data_b(:,4),'k.')
plot(xx/1e3,predict(wnlm,xx)-0.5989,'k--','linewidth',1.5)
xlabel('Applied laser power (mW)','interpreter','latex')
